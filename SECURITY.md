...
```
https://github.com/OpenSecOps-Org/SOAR-soc-incident-when-s3-tag-applied/releases/download/<VERSION>/SOAR-soc-incident-when-s3-tag-applied-<VERSION>-sbom.cdx.json
```
...
Together they are the authoritative cross-component references; the per-component sections above describe how the project-wide posture applies to **SOAR-soc-incident-when-s3-tag-applied** specifically.
