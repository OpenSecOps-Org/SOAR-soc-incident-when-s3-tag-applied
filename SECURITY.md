...
That document is the authoritative cross-component reference; the per-component sections above describe how the project-wide posture applies to **SOAR-soc-incident-when-s3-tag-applied** specifically.
